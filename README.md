...
### `dividendRatio`
For each type of accepted token, `dividendRatio` represents the number of tokens [previously made available as dividends](#dividend_fraction) to the [total supply of the instance token](#totalsupply).
